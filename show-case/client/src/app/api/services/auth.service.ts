...
export class AuthService extends BaseService {
  ...
  getUserAuthenticated(
   ...
   loginFormModel(options?: Partial<FormModel> & { displayProperties?: (keyof User & string)[] }, value?: { 'password': string, 'email': string }) {
   ...
   setPasswordFormModel(options?: Partial<FormModel> & { displayProperties?: (keyof User & string)[] }, value?: { 'rePassword': string, 'password': string, 'email': string }) {
    const schema: any = UserSchema;
