...
export class AuthService extends BaseService {
  ...
  loginFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof { password: string; email: string } & string)[] },
  ...
  setPasswordFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof { rePassword: string; password: string; email: string } & string)[] },
    value?: { rePassword: string; password: string; email: string }
  ) {
    const schema: any = UserSchema;
