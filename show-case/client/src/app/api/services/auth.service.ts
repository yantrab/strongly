...
export class AuthService extends BaseService {
  ...
  login(      params:  { 'password': string, 'email': string }
   ...
   loginFormGroup(value?:{ 'password': string, 'email': string }) {
    let schema: any = {"properties":{"password":{"type":"string","notEmptyString":true,"minLength":6},"email":{"format":"email","type":"string","notEmptyString":true}},"type":"object","required":["password","email"]}
    if (schema["ref"]){
